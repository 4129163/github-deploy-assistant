...
const precheckRoutes = require('../routes/precheck');
app.use('/api/precheck', precheckRoutes);         // 功能：部署前预检清单
const precheckFixRoutes = require('../routes/precheck-fix');
app.use('/api/precheck/fix', precheckFixRoutes);  // 功能：一键修复
